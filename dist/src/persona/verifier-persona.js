...
exports.TOURNAMENT_VERIFIER_PERSONA = void 0;
exports.renderVerifierPrompt = renderVerifierPrompt;
exports.parseVerifierScore = parseVerifierScore;
 ...
 */
exports.TOURNAMENT_VERIFIER_PERSONA = {
 ...
 */
function renderVerifierPrompt(obligation, candidateText, candidateIndex) {
    const lines = [
        `Obligation:`,
 ...
 * failure mode.
 */
function parseVerifierScore(rawText) {
    ...
    try {
        ...
        return {
            score: 0,
            rationale: `verifier JSON parse error: ${err.message.slice(0, 80)}`,
            rawText,
        };
    }
    ...
    const rationale = typeof rawRationale === 'string' && rawRationale.length > 0
 ...
 */
async function scoreCandidate(session, obligation, candidateText, candidateIndex, options = {}) {
    const persona = options.persona ?? exports.TOURNAMENT_VERIFIER_PERSONA;
    const request = {
