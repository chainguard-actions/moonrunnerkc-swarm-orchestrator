...
exports.renderProjectContext = renderProjectContext;
...
function parseRunFlags(argv) {
    ...
    const flags = {
        ...
        maxObligations: maxObligationsRaw !== undefined
            ? (0, argv_schema_1.requirePositiveInt)(maxObligationsRaw, '--max-obligations')
            : null,
        ...
        snapshotCleanup: (0, argv_schema_1.readString)(values, 'snapshot-cleanup') ?? '',
        falsifierScheduler: falsifierSchedulerRaw !== undefined
            ? (0, argv_schema_1.requireEnum)(falsifierSchedulerRaw, '--falsifier-scheduler', ['sequential', 'ucb1'])
            : 'sequential',
