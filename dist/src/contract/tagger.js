...
const scaffold_template_1 = require("../wasm/strategies/scaffold-template");
/**
...
function pickStrategyForFile(relPath, available) {
    if (available.has('scaffold-template') && (0, scaffold_template_1.hasTemplateFor)(relPath)) {
...
function isKnownBoilerplate(relPath) {
    return (0, scaffold_template_1.hasTemplateFor)(path.basename(relPath));
}
