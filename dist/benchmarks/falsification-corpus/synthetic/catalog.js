...
exports.SYNTHETIC_CASES = void 0;
...
function swallowing(id, catchLine) {
    return {
        id,
...
function testModification(id, before, after) {
    return {
        id,
...
function mockMutation(id, before, after) {
    return {
        id,
...
function regression(id, stable, broken) {
    return {
        id,
        category: 'regression',
...
function edgeCase(id, fn, brokenBody, cleanBody) {
    return {
        id,
