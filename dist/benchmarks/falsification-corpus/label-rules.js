...
exports.LABELING_RULES_PROMPT = exports.BROKEN_CATEGORIES = void 0;
exports.validateGroundTruthLabel = validateGroundTruthLabel;
exports.parseBrokenCategories = parseBrokenCategories;
exports.validateBrokenCategories = validateBrokenCategories;
exports.countSentences = countSentences;
exports.BROKEN_CATEGORIES = [
    'goal-not-fixed',
    'regression',
...
function parseBrokenCategories(input) {
    return input
        .split(',')
        .map(item => item.trim())
        .filter(Boolean)
...
function validateBrokenCategories(categories) {
    const allowed = new Set(exports.BROKEN_CATEGORIES);
    return categories
