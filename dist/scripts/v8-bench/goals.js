...
exports.BENCH_GOALS = void 0;
exports.assertSuiteShape = assertSuiteShape;
/**
 ...
 */
function assertSuiteShape() {
    const counts = { small: 0, medium: 0, large: 0 };
    for (const g of exports.BENCH_GOALS)
        counts[g.size] += 1;
    if (counts.small !== 5 || counts.medium !== 3 || counts.large !== 2) {
        throw new Error(`bench suite must be 5+3+2 (impl guide §5); got ${JSON.stringify(counts)}`);
    }
}
